...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post contributions_url, params: { contribution: { description: @contribution.description, investigation_group_id: @contribution.investigation_group_id, name: @contribution.name, publication_date: @contribution.publication_date } }
    end
