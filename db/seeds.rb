...
for i in (1..100)
	...
	Event.create!( name: random_string(10), date_time: DateTime.new(2016,  aleatorio.rand(1..12),  aleatorio.rand(1..30),  aleatorio.rand(1..20),  aleatorio.rand(1..50), 0), description: random_string(40), investigation_group_id:  aleatorio.rand(1..100))
