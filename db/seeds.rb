...
for i in (1..100)
	...
	Student.create!( first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: "#{us}@unal.edu.co", username: us, investigation_group_id: group, password: Faker::Internet.password(8) )
